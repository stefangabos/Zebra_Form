...
/**
 *  Create `<textarea>` form elements
 *
 *  @author     Stefan Gabos <contact@stefangabos.ro>
 *  @copyright  © 2006 - 2022 Stefan Gabos
 *  @package    Elements
 */
class Zebra_Form_Textarea extends Zebra_Form_Shared {
     ...
     *
     *  // add a label
     *  $form->add('label', 'label_my_textarea', 'my_textarea', 'Type something');
     *
     *  // add a textarea control to the form
     *  $element = $form->add('textarea', 'my_textarea');
     *
     *  // make it required
     ...
     *                                  // for an element named "my_textarea", one would use:
     *                                  echo $my_textarea;
     *                                  </code>
     *
     ...
     *                                  {@link https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea textarea}
    ...
    function __construct($id, $default = '', $attributes = '') {
        ...
        $this->set_attributes(array(
            ...
            'id'        =>  $id,
            'rows'      =>  5,
            'cols'      =>  '80',                   // used for passing W3C validation
            'class'     =>  'zebraform-control',
            'type'      =>  'textarea',
            'value'     =>  $default,
        ));
