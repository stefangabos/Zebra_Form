...
/**
 *  Create `<input type="image">` form elements
 *
 *  @author     Stefan Gabos <contact@stefangabos.ro>
 *  @copyright  © 2006 - 2022 Stefan Gabos
 *  @package    Elements
 */
class Zebra_Form_Image extends Zebra_Form_Shared {
     ...
     *  $form->add('image', 'my_image', 'path/to/image');
     *
     ...
     *                                  // for an element named "my_image", one would use:
     *                                  echo $my_image;
     *                                  </code>
     *
     *  @param  string  $src            Path to an image file.
     *
     *  @param  array   $attributes     (Optional) An array of attributes valid for
     *                                  {@link https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/image image input}
     ...
     *                                  and should not be altered manually: `id`, `name`, `type`, `src`.
     *
     *  @return void
     */
