...
/**
 *  Create `<input type="reset">` form elements
 *
 *  @author     Stefan Gabos <contact@stefangabos.ro>
 *  @copyright  © 2006 - 2022 Stefan Gabos
 *  @package    Elements
 */
class Zebra_Form_Reset extends Zebra_Form_Shared {
     ...
     *
     *  // add a reset element to the form
     *  $form->add('reset', 'my_reset', 'Reset');
     *
     ...
     *                                  // for an element named "my_reset", one would use:
     *                                  echo $my_reset;
     *                                  </code>
     *
     *  @param  string  $caption        Label of the reset button element.
     *
     *  @param  array   $attributes     (Optional) An array of attributes valid for
     *                                  {@link https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/reset reset input}
