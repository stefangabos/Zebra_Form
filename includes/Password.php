...
/**
 *  Create `<input type="password">` form elements
 *
 *  @author     Stefan Gabos <contact@stefangabos.ro>
 *  @copyright  © 2006 - 2022 Stefan Gabos
 *  @package    Elements
 */
class Zebra_Form_Password extends Zebra_Form_Shared {
     ...
     *
     *  // add a label
     *  $form->add('label', 'label_my_password', 'my_password', 'Password');
     *
     *  // add a password element to the form
     *  $element = $form->add('password', 'my_password');
     *
     *  // make it required
     ...
     *                                  // for an element named "my_password", one would use:
     *                                  echo $my_password;
     *                                  </code>
     *
     ...
     *                                  {@link https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/password password input}
    ...
    function __construct($id, $default = '', $attributes = '') {
        ...
        $this->set_attributes(array(
            ...
            'id'        =>  $id,
            'value'     =>  $default,
            'class'     =>  'zebraform-control zebraform-password',
        ));
