...
var jscolor = {
    ...
    dir : '/ZebraForm/', // location of jscolor directory (leave empty to autodetect)
    ...
    color : function(target, prop) {
        ...
        function drawPicker(x, y) {
            ...
            p.padM.style.backgroundImage = "url('"+jscolor.getDir()+"public/css/cross.gif')";
            p.padM.style.backgroundRepeat = "no-repeat";
            p.sldM.style.backgroundImage = "url('"+jscolor.getDir()+"public/css/arrow.gif')";
            p.sldM.style.backgroundRepeat = "no-repeat";
            p.pad.style.backgroundImage = "url('"+jscolor.getDir()+"public/css/"+padImg+"')";
        ...
        // require images
        switch(modeID) {
            case 0: jscolor.requireImage('public/css/hs.png'); break;
            case 1: jscolor.requireImage('public/css/hv.png'); break;
        }
        jscolor.requireImage('public/css/cross.gif');
        jscolor.requireImage('public/css/arrow.gif');
